/*
 ...
 Lab 3
 Problem 3.3
 Description of problem: This program is essentially the same as 3.2 with the
 exception that it has a friend function operator== which tests to see
 if two objects are equivalent. The two objects are equivalent if they
 have the same reportingMark and number.
